...
BEGIN
  ...
  CONVERT: PROCESS(keys)
  BEGIN
	CASE keys IS
		WHEN "1000000000000000" => sal <= "00001";
		WHEN "0100000000000000" => sal <= "00010";
		WHEN "0010000000000000" => sal <= "00011";
		WHEN "0001000000000000" => sal <= "00100";
		WHEN "0000100000000000" => sal <= "00101";
		WHEN "0000010000000000" => sal <= "00110";
		WHEN "0000001000000000" => sal <= "00111";
		WHEN "0000000100000000" => sal <= "01000";
		WHEN "0000000010000000" => sal <= "01001";
		WHEN "0000000001000000" => sal <= "01010";
		WHEN "0000000000100000" => sal <= "01011";
		WHEN "0000000000010000" => sal <= "01100";
		WHEN "0000000000001000" => sal <= "01101";
		WHEN "0000000000000100" => sal <= "01110";
		WHEN "0000000000000010" => sal <= "01111";
		WHEN "0000000000000001" => sal <= "10000";
		WHEN OTHERS => sal <= "00000";
	END CASE;
  END PROCESS CONVERT;
